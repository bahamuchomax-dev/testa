...
window.__oxBg=(function(){
  ...
  function injectCSS(){
    ...
    st.textContent=[
      ...
      'body.oxbg-on .rx-planbtn{background:rgba(255,255,255,.84)!important;background:color-mix(in srgb,var(--card,#fff) 84%,transparent)!important;backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px)}'
    ].join("");
